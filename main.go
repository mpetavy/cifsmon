...
func main() {
	...
	common.New(&common.App{"cifsmon", "1.0.0", "2018", "monitor the accessibility of shares", "mpetavy", common.APACHE, "https://github.com/mpetavy/traclink", true, nil,nil, nil, tick, time.Second * 5}, []string{"h", "u", "w", "d"})
	common.Run()
}
