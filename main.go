...
func init() {
	common.Init("1.0.0", "2018", "monitor the accessibility of shares", "mpetavy", fmt.Sprintf("https://github.com/mpetavy/%s", common.Title()), common.APACHE, true, nil, nil, tick, time.Second*5)
