...
func init() {
	common.Init(true, "1.0.0", "", "2018", "monitor the accessibility of shares", "mpetavy", fmt.Sprintf("https://github.com/mpetavy/%s", common.Title()), common.APACHE, nil, nil, run, time.Second*5)
